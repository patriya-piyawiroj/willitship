...
class BillOfLading(Base):
    ...
    # Location fields from billOfLading
    place_of_receipt = Column(String(255), nullable=True)  # From billOfLading.placeOfReceipt
    place_of_delivery = Column(String(255), nullable=True)  # From billOfLading.placeOfDelivery
